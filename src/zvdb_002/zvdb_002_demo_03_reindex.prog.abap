...
*&
*&---------------------------------------------------------------------*
REPORT zvdb_002_demo_03_reindex MESSAGE-ID zvdb_002.
...
FORM reembed.
  ...
  DATA(lo_progress) = zcl_vdb_000_progress=>new( iv_total = lines( lt_v ) iv_step  = 100
  ).
